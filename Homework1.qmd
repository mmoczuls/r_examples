...
plot(x=nitrogenaverage$Month, y=nitrogenaverage$Nitrogen, pch=18, xlab= "Month", 
     ylab = "Nitrogen (mg/L)", col = "#1F4C9A", main ="Nitrogen values at different parts of the year")
```
